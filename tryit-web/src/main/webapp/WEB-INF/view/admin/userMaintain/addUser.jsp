            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="userDataForm" role="form">
                        ...
                        <button id="addUserButton" type="button" class="btn btn-success"><i
                                class="glyphicon glyphicon-plus"></i> 新增
                        </button>
                        <button id="resetButton" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置
                        </button>
                    </form>
                </div>
            </div>
