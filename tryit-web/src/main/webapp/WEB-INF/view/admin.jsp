...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:22px;" href="#">tryit 用户管理系统 - 控制面板</a></div>
        </div>
            ...
            <div class="tree">
                <ul style="padding-left:0;" class="list-group">
                    <li class="list-group-item tree-closed">
                        <a href="admin"><i class="glyphicon glyphicon-dashboard"></i>控制面板</a>
                    </li>
                    <li class="list-group-item tree-closed">
                        ...
                        <ul style="margin-top:10px;display:none;">
                            <li style="height:30px;">
                                <a href="admin/userMaintain"><i class="glyphicon glyphicon-user"></i> 用户维护</a>
                            </li>
                            <li style="height:30px;">
